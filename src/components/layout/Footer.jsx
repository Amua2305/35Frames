      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col space-y-3 text-gray-900 text-lg items-center">
          ...
          <div className="flex gap-4 justify-center mt-6 ">
              <a href="https://www.instagram.com/storiesby35frames?utm_source=qr&igsh=MW01bzNmcTZybGM5Ng%3D%3D">
            <FaInstagram  size={25}/>
              </a>
              <a href="https://wa.me/919902783821">
            <FaWhatsapp   size={25}/>
              </a>
              <a href="https://youtube.com/@35framesphotography?si=DtsFF4HJG9rE4Nl3">
            <AiOutlineYoutube size={25}/>
              </a>
          </div>
      {/* COPYRIGHT */}
      <div className="text-center text-gray-600 text-sm mt-10">
        Copyright © 2025 storiesby35frames.
      </div>
    </footer>
  );
}
